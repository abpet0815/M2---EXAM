export default class GameScene3 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.tilemapTiledJSON('tilemap3', './assets/maps/grassmap.tmj');
    ...
    create(){
        ...
        let bg13 = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'bg13').setScale(0.5).setScrollFactor(0.3);
        let bg14 = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'bg14').setDepth(-2).setScale(0.5).setScrollFactor(0.3);
        let bg15 = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'bg15').setDepth(-3).setScale(0.5).setScrollFactor(0.1);
        let bg16 = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'bg16').setDepth(-4).setScale(0.5).setScrollFactor(0.2);
        let bg17 = this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'bg17').setDepth(-5).setScale(0.5).setScrollFactor(0);

        
        this.cameras.main.startFollow(bg17);
        
        this.cameras.main.on('camerafadeoutcomplete', function () {
            this.cameras.main.fadeIn(2000);
            this.cameras.main.setScroll(0, 0);
            this.cameras.main.setBounds(0, 0, bg17.width, bg17.height);
        }, this);
        
        this.cameras.main.setBounds(0, 0, bg17.width * 2, bg17.height);
        ...
        this.cameras.main.on('cameraupdate', function () {
            bg13.x = this.cameras.main.scrollX * 0.1;
            bg14.x = this.cameras.main.scrollX * 0.3;
            bg15.x = this.cameras.main.scrollX * 0.6;
            bg16.x = this.cameras.main.scrollX * 0.9;
            bg17.x = this.cameras.main.scrollX * 0.9;

        }, this);

        //BGM
        this.sound.play("gameBGM3", { loop: true, volume: 0.3 });
